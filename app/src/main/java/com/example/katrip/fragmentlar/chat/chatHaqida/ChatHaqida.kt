package com.example.katrip.fragmentlar.chat.chatHaqida
...
import com.example.katrip.databinding.ActivityChatHaqidaBinding
...
class ChatHaqida : AppCompatActivity() {
    lateinit var binding: ActivityChatHaqidaBinding
