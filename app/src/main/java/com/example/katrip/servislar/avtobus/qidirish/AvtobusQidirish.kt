package com.example.katrip.servislar.avtobus.qidirish
...
class AvtobusQidirish : Fragment(),TakliflarLayfxaklarAdapter.onClickListener {
    ...
    private fun takliflarLayfxaklar() {
        userViewModel.readUser.observe(requireActivity(), androidx.lifecycle.Observer {
            ...
            takliflarLayfxaklarViewModel.takliflarLayfxaklar(it.get(0).token.toString(),"bus")
            {
                if(it.isSuccessful){
