package com.example.katrip.servislar.turarJoylar.qidirish.turarJoyRuyxati
...
import com.example.katrip.servislar.turarJoylar.adapter.turarJoyRuyxati.IzlanganTurarJoyAdapter
import com.example.katrip.servislar.turarJoylar.qidirish.turarJoyHaqida.TurarJoyHaqida

class TurarJoylarRuxati : AppCompatActivity(),
    IzlanganTurarJoyAdapter.izlanganTurarJoySetOnClickListener {
    ...
    private val izlanganTurarJoyAdapter: IzlanganTurarJoyAdapter by lazy {
        IzlanganTurarJoyAdapter(this)
    }
    private var shaxar = ""
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shaxar = intent.getStringExtra("shaxar").toString()
        binding.apply {
            shaxarNomi.setText(intent.getStringExtra("shaxar").toString())
            holat.setText(intent.getStringExtra("xona")
                .toString() + " xona | " + intent.getStringExtra("kishi").toString() + " kishi")
        }
    ...
    private fun turarJoylar(arr: List<Arr>) {
        binding.apply {
            ...
            turarJoyRecycler.layoutManager = LinearLayoutManager(this@TurarJoylarRuxati)
        }
        izlanganTurarJoyAdapter.setData(arr, shaxar)
    }
    ...
    override fun izlanganTurarJoySetOnClickListener(id: Int) {
        val intent = Intent(this, TurarJoyHaqida::class.java)
